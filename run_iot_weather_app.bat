...
powershell -Command "[System.Guid]::NewGuid().ToString() | Set-Content -Path 'secrets/iot_temp_admin_password.txt'"

:: Generate password for iot_temp_data_gen_password
powershell -Command "[System.Guid]::NewGuid().ToString() | Set-Content -Path 'secrets/iot_temp_data_gen_password.txt'"

:: Generate password for iot_temp_web_viewer_password
powershell -Command "[System.Guid]::NewGuid().ToString() | Set-Content -Path 'secrets/iot_temp_web_viewer_password.txt'"
